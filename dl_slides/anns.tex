...
\subtitle{CMU PhD Workshop on Computational Economics}
...
\begin{frame}
    ...
    \begin{itemize}
        \item 1940s--1980s: mathematical models of NNs, perceptrons, backpropagation
        \vspace{0.5em}
        \item 1990s--2000s: SVMs rival ANNs; DL starts finding successes in large problems
        \vspace{0.5em}
        \item Since $\sim$2012: explosion of progress --- CNNs, RNNs, transformers, LLMs, etc.
    \end{itemize}
...
\begin{frame}{Gradient descent}
    ...
    \begin{itemize}
        ...
        \item in practice replace $\ell(\theta)$ with batched loss $\to$
            ...
            \end{equation*}
        \item many extensions: momentum, regularization, cross-entropy loss, etc.
    \end{itemize}
