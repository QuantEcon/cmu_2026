...
\begin{frame}
    ...
    \begin{figure}
        \centering
        \scalebox{0.5}{\includegraphics{figures/chaos_intro_quad_map.pdf}}
...
\begin{frame}
    ...
    \begin{figure}
        \centering
        \scalebox{0.5}{\includegraphics{figures/chaos_intro_traj.pdf}}
...
\begin{frame}
    ...
    \begin{figure}
        \centering
        \scalebox{0.5}{\includegraphics{figures/chaos_intro_quad_map_iter.pdf}}
...
\begin{frame}
    ...
    \begin{figure}
        \centering
        \scalebox{0.5}{\includegraphics{figures/chaos_intro_time_series_hist.pdf}}
...
\begin{frame}
    ...
    \begin{figure}
        \centering
        \scalebox{0.5}{\includegraphics{figures/chaos_intro_time_series_hist_fstar.pdf}}
...
\begin{frame}
    ...
    function $h$ with $\int |h(x)| \psi^*(x) \diff x < \infty$, we have
    %
    \begin{equation}\label{eq:berg}
        \frac{1}{m} \sum_{t=1}^m \int h(g^t(x_0))
        \to 
...
\begin{frame}
   ...
   On the right we show the histogram of $(g^t(x_0^i))_{i=1}^n$ and the density
    $\psi^*$ 
...
\begin{frame}
    ...
    \begin{figure}
        \centering
        \scalebox{0.30}{\includegraphics{figures/chaos_intro_hists.pdf}}
